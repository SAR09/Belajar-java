...
public class JpaQueryLanguangeTest {
    ...
    void whereClauses() {
        ...
        query.setParameter("firstName", "Saiful");
        query.setParameter("lastName", "Amin");
    ...
    void selectNewConstructor() {
        ...
        TypedQuery<SimpleBrand> query = entityManager.createQuery("select new programmermuda.jpa.entity.SimpleBrand(b.id, b.name) from Brand b where b.name = :name", SimpleBrand.class);
        query.setParameter("name", "Xiaomi");
    ...
    void nonQuery() {
        ...
        int inpectedRecords = query.executeUpdate();
        System.out.println("Success update " + inpectedRecords + " records");
